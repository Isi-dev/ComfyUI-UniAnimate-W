...
def mp_main(reference_image, video):
    ...
    for i in range(num_frames):
        ...
        frame = video[i].permute(0, 1, 2).cpu().numpy()*255  # Convert to HWC format and numpy array
    ...
    ref_frame = reference_image.squeeze(0).cpu().numpy()*255  # Convert to HWC format and numpy array
    ...
    # Prepare to return the dwpose images
    dwpose_images = []
